...
/**
 * Describe a project's target date for display: the formatted date, tinted
 * with the destructive token when it's in the past and the project is still
 * active. Returns `null` when there is no target date.
 */
